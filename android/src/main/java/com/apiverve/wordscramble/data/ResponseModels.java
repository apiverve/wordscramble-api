...
//
//     WordScrambleGeneratorData data = Converter.fromJsonString(jsonString);

package com.apiverve.wordscramble.data;
...
public class Converter {
    ...
    public static WordScrambleGeneratorData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(WordScrambleGeneratorData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(WordScrambleGeneratorData.class);
        writer = mapper.writerFor(WordScrambleGeneratorData.class);
    }
...
// WordScrambleGeneratorData.java

package com.apiverve.wordscramble.data;

import com.fasterxml.jackson.annotation.*;

public class WordScrambleGeneratorData {
