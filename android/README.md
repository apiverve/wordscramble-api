# Word Scramble Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordscramble-api:1.1.12'
}
```
...
```java
import com.apiverve.wordscramble.WordScrambleGeneratorAPIClient;
import com.apiverve.wordscramble.APIResponse;
import com.apiverve.wordscramble.APIException;

// Initialize the client
WordScrambleGeneratorAPIClient client = new WordScrambleGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordscramble](https://docs.apiverve.com/ref/wordscramble)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordscramble](https://docs.apiverve.com/ref/wordscramble)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordscramble-api/issues)
