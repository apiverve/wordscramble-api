...
```bash
curl -X GET "https://api.apiverve.com/v1/wordscramble?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/wordscramble](https://docs.apiverve.com/ref/wordscramble)

---

## Use Cases

Common use cases for the Word Scramble Generator API:
