...
class TestWordscrambleAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WordscrambleAPIClient(self.api_key)

    @patch('apiverve_wordscramblegenerator.apiClient.requests.get')
