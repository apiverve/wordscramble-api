// Package wordscramble provides a Go client for the Word Scramble Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/wordscramble?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/wordscramble"
	defaultTimeout = 30 * time.Second
)

// Client is the Word Scramble Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Word Scramble Generator API client.
...
// Execute makes a request to the Word Scramble Generator API with typed parameters.
//
...
//   - difficulty: string - Difficulty level (affects word length)
//   - count: integer - Number of puzzles [min: 1, max: 20]
